...
//    FeatureUsageTracker.FileTemplateConfig().triggerFeatureUsed(getFeatureUsedKey()); //todo register a ProductivityFeaturesProvider extension
    ...
    private void show(@NotNull final Project project,
        ...
        final JBList<AdditionalAction> list = new JBList<>(new CollectionListModel<>(additionalActions));
        ...
        if (gotoData.listUpdaterTask != null) {
            gotoData.listUpdaterTask.init(popup, new JBListUpdater<>(list), usageView);
    ...
    public static class GotoData {
        ...
        public BackgroundUpdaterTask listUpdaterTask; // todo un-used. check relevancy for future features
